...
class SectorFilter extends Filters
{
  /** 
   ...
   * @var array
   */
  protected $filters = ['query', 'include', 'sort', 'limit', 'municipalityId'];
  ...
  protected function municipalityId($value){
    if($value != 'null'){
      return $this->builder->whereMunicipalityId($value);
    }
  }
}
